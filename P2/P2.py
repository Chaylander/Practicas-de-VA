...
while contador<11:
    ...
    if opcion == "R":
        ...
        if contador != 12:
            img1 = cv2.imread('monokuma_res.jpg')
            cv2.imshow('Imagen 1',img1)
            img2 = cv2.imread('thewitcher_res.jpg')
            ...
            if contador == 1:
                ...
                print('resultado[0,0]= ',ressuma[0,0])
                
                cv2.imshow('Suma',ressuma)
                cv2.imwrite('suma.jpg',ressuma)
                
                #Histograma de la imagen1
                histograma_imagen1=plt.imread('monokuma_res.jpg')
                plt.imshow(histograma_imagen1)
                #plt.hist(ressuma.ravel())
